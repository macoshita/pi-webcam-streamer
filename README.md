...
- Suppress logs when the camera is disconnected
- Implement reconnection logic when the camera is reconnected
- Support multiple cameras (remove `camera_index` option, allow selection in UI)
- Handle Raspberry Pi Wi-Fi disconnection/reconnection (need to define specifications first)
